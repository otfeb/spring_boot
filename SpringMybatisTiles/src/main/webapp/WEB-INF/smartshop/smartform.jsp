...
<body>
<form action="smart/smartaction.jsp" method="post" enctype="multipart/form-data">
	<table class="table table-bordered" style="width: 800px;margin-left: 100px;">
		<caption><b>상품등록</b></caption>
		<tr>
			<th width="120">상품명</th>
			<td>
				<input type="text" name="sangname" class="form-control" placeholder="상품명" required="required">
			</td>		
			
			<th width="120">가격</th>
			<td>
				<input type="text" name="price" class="form-control" required="required" placeholder="가격입력">
			</td>
